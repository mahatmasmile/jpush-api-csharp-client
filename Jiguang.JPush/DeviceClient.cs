...
namespace Jiguang.JPush
{
    public class DeviceClient
    {
        ...
        public HttpResponse UpdateDeviceInfo(string registrationId, string json)
        {
            if (string.IsNullOrEmpty(registrationId))
        ...
        public HttpResponse GetDevicesByAlias(string alias, string platform)
        {
            ...
            var contentTask = msg.Content.ReadAsStringAsync();
            contentTask.Wait();
            string responseConetent = contentTask.Result;
